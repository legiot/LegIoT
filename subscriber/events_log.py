...
# Calculated from the 1st 6 characters of SHA-512("logmanagement"):
COOKIEJAR_TP_ADDRESS_PREFIX = 'f7a9dd'
...
def listen_to_events(delta_filters=None):
    ...
    log_subscription = events_pb2.EventSubscription(
        event_type="Log-Management")
    request = client_event_pb2.ClientEventsSubscribeRequest(
        subscriptions=[log_subscription])
